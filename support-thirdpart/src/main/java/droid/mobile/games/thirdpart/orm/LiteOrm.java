 ...
 */
package droid.mobile.games.thirdpart.orm;

import android.content.Context;
import android.database.Cursor;
import android.database.sqlite.SQLiteClosable;
import android.database.sqlite.SQLiteDatabase;
import droid.mobile.games.thirdpart.orm.db.DataBase;
import droid.mobile.games.thirdpart.orm.db.DataBaseConfig;
import droid.mobile.games.thirdpart.orm.db.TableManager;
import droid.mobile.games.thirdpart.orm.db.assit.*;
import droid.mobile.games.thirdpart.orm.db.impl.CascadeSQLiteImpl;
import droid.mobile.games.thirdpart.orm.db.impl.SingleSQLiteImpl;
import droid.mobile.games.thirdpart.orm.db.model.*;
import droid.mobile.games.thirdpart.orm.db.utils.ClassUtil;
...
public abstract class LiteOrm extends SQLiteClosable implements DataBase {
     ...
     *
     * @return {@link droid.mobile.games.thirdpart.orm.db.impl.CascadeSQLiteImpl}
     */
