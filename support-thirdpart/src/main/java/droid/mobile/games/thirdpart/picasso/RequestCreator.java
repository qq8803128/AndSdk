...
import static droid.mobile.games.thirdpart.picasso.BitmapHunter.forRequest;
import static droid.mobile.games.thirdpart.picasso.MemoryPolicy.NO_CACHE;
import static droid.mobile.games.thirdpart.picasso.MemoryPolicy.NO_STORE;
import static droid.mobile.games.thirdpart.picasso.MemoryPolicy.shouldReadFromMemoryCache;
import static droid.mobile.games.thirdpart.picasso.Picasso.LoadedFrom.MEMORY;
import static droid.mobile.games.thirdpart.picasso.Picasso.Priority;
import static droid.mobile.games.thirdpart.picasso.PicassoDrawable.setBitmap;
import static droid.mobile.games.thirdpart.picasso.PicassoDrawable.setPlaceholder;
import static droid.mobile.games.thirdpart.picasso.RemoteViewsAction.AppWidgetAction;
import static droid.mobile.games.thirdpart.picasso.RemoteViewsAction.NotificationAction;
import static droid.mobile.games.thirdpart.picasso.Utils.OWNER_MAIN;
import static droid.mobile.games.thirdpart.picasso.Utils.VERB_CHANGED;
import static droid.mobile.games.thirdpart.picasso.Utils.VERB_COMPLETED;
import static droid.mobile.games.thirdpart.picasso.Utils.VERB_CREATED;
import static droid.mobile.games.thirdpart.picasso.Utils.checkMain;
import static droid.mobile.games.thirdpart.picasso.Utils.checkNotMain;
import static droid.mobile.games.thirdpart.picasso.Utils.createKey;
import static droid.mobile.games.thirdpart.picasso.Utils.log;
