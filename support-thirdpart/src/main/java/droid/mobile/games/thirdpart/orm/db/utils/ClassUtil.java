...
import droid.mobile.games.thirdpart.orm.db.annotation.MapCollection;
...
public class ClassUtil {
     ...
     * 判断类是否是基础数据类型
     * 目前支持11种
     * 在{@link droid.mobile.games.thirdpart.orm.db.utils.DataUtil#injectDataToObject} 中注入也有体现
     */
