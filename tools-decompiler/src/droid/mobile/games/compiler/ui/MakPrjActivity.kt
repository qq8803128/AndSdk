...
import droid.mobile.games.compiler.Color
import droid.mobile.games.compiler.appendText
import droid.mobile.games.compiler.config.And
import droid.mobile.games.compiler.config.Inputs
import droid.mobile.games.compiler.config.Project
import droid.mobile.games.compiler.config.Properties
import droid.mobile.games.compiler.reflect.Reflect
import droid.mobile.games.compiler.task.Task
import droid.mobile.games.compiler.util.FileUtils
import droid.mobile.games.compiler.util.FileUtils.*
import droid.mobile.games.compiler.util.TextUtils
import droid.mobile.games.compiler.xml.Item
import droid.mobile.games.compiler.xml.Manifest
import droid.mobile.games.compiler.xml.Public
...
class MakPrjActivity : BaseActivity() {
    ...
    fun getTask(): Task?{
        try{
            ...
            val className = "droid.mobile.games.compiler.dynamic.BuildTask"
